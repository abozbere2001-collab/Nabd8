...
export function NabdAlMalaebLogo(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      {/* Left Penalty Arc */}
      <path d="M 35 55 A 4 4 0 0 1 35 75" fill="none" stroke="currentColor" strokeWidth="2" />
      ...
      {/* Right Penalty Arc */}
      <path d="M 165 55 A 4 4 0 0 0 165 75" fill="none" stroke="currentColor" strokeWidth="2" />
