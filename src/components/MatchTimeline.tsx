...
import { FaFutbol, FaArrowsRotate } from "react-icons/fa6";
import { IoSquare } from "react-icons/io5"; // لأيقونات البطاقات
          ...
          {filteredEvents
            ...
            .map((event, index) => {
              ...
              >
                {/* الحاوية لكل حدث */}
                <div
                  className={`relative flex items-center gap-2 px-3 py-1.5 rounded-2xl shadow-md text-sm text-white max-w-[140px] bg-green-700`}
                >
