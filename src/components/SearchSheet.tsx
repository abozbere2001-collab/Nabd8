...
export function SearchSheet({ children, navigate }: { children: React.ReactNode, navigate: (screen: ScreenKey, props?: Record<string, any>) => void; }) {
  ...
  return (
    <>
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        <SheetContent side="top" className="h-full flex flex-col" onOpenAutoFocus={(e) => e.preventDefault()}>
          <SheetHeader>
