...
export function WelcomeScreen({ onOnboardingComplete }: WelcomeScreenProps) {
      ...
      <div className="flex flex-1 flex-col items-center justify-center p-8 text-center">
        ...
        <div className="w-full max-w-xs space-y-4">
            <Button onClick={handleGoogleLogin} className="w-full" disabled={!!loading} size="lg">
              {loading === 'google' ? <Loader2 className="h-5 w-5 mr-2 animate-spin" /> : <GoogleIcon className="h-5 w-5 mr-2" />}
